...
$user = new SignupController($conn);
$signup = $user->signUp();
?>
<!DOCTYPE html>
...
<body class="bg-gray-100 dark:bg-gray-800">
    ...
    <div id="status" class="hidden right-0 bottom-0 z-50 fixed bg-green-500 px-6 py-2 border rounded-lg w-fit text-gray-200 text-lg text-center -translate-6"></div>

    <form
        action="signup.php"
        method="POST"
        id="signup-form"
        class="relative flex justify-center items-center sm:mx-auto py-3 sm:max-w-xl">
        <div
            ...
            <div class="mx-auto max-w-md">
                ...
                <div class="mt-5">
                    <!-- name -->
                    <label
                        class="block pb-1 font-bold text-gray-600 text-md"
                        for="username">
                        <span data-lang="vi" class="font-bold dark:text-gray-200">Tên người dùng</span>
                        <span data-lang="en" class="hidden font-bold dark:text-gray-200">Username</span>
                        <span id="username-error" class="text-md text-red-500 dark:text-red-400"></span>
                    </label>
                    <input
                        class="mt-1 mb-5 px-3 py-2 border dark:border-gray-400 rounded-lg w-full dark:text-gray-200 text-sm"
                        type="text"
                        name="username"
                        id="username"
                        require />
                    ...
                    <label
                        class="block pb-1 font-bold text-gray-600 text-md"
                        for="email">
                        <span data-lang="vi" class="font-bold dark:text-gray-200">E-mail</span>
                        <span data-lang="en" class="hidden font-bold dark:text-gray-200">E-mail</span>
                        <span id="email-error" class="text-md text-red-500 dark:text-red-400"></span>
                    </label>
                    <input
                        class="mt-1 mb-5 px-3 py-2 border dark:border-gray-400 rounded-lg w-full dark:text-gray-200 text-sm"
                        type="text"
                    ...
                    <label
                        ...
                        <span id="password-error" class="text-md text-red-500 dark:text-red-400"></span>
                    </label>
                    <input
                        class="mt-1 mb-5 px-3 py-2 border dark:border-gray-400 rounded-lg w-full dark:text-gray-200 text-sm"
                        type="password"
                    ...
                    <label
                        ...
                        <span data-lang="vi" class="font-bold dark:text-gray-200">Xác thực mật khẩu</span>
                        <span data-lang="en" class="hidden font-bold dark:text-gray-200">Confirm Password</span>
                        <span id="confirm-password-error" class="text-md text-red-500 dark:text-red-400"></span>
                    </label>
                    <input
                        class="mt-1 mb-5 px-3 py-2 border dark:border-gray-400 rounded-lg w-full dark:text-gray-200 text-sm"
                        type="password"
                ...
                <div class="flex justify-center items-center w-full">
                    <div class="w-full">
                        <button
                            ...
                            <span data-lang="vi"><span class="hidden sm:inline-block">Đăng ký với Google</span></span>
                            <span data-lang="en" class="hidden"><span class="hidden sm:inline-block">Sign up with Google</span></span>
                        </button>
                        <button
                            name="apple"
                            ...
                            <span data-lang="vi"><span class="hidden sm:inline-block">Đăng ký với Apple</span></span>
                            <span data-lang="en" class="hidden"><span class="hidden sm:inline-block">Sign up with Apple</span></span>
                        </button>
                    </div>
                </div>
                <div class="mt-5">
                    <button
                        ...
                        type="submit"
                        name="signup">
                        <span data-lang="vi">Đăng Ký</span>
                        <span data-lang="en" class="hidden">Signup</span>
                    </button>
                </div>
                <div class="flex justify-between items-center mt-4">
                    ...
                    <a
                        ...
                        href="login.php">
                        <span data-lang="vi">hoặc đăng nhập</span>
                        <span data-lang="en" class="hidden">or login</span>
                    </a>
                    <span class="dark:border-gray-400 border-b w-1/5 md:w-1/4"></span>
                </div>
            </div>
    ...
    <script>
        handleFormSignup('signup-form', 'signup-api.php', '/app/Views/login.php');
    </script>
